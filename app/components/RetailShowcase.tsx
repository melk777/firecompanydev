...
export default function RetailShowcase() {
  ...
  return (
    <section className="relative min-h-screen bg-[#000000] py-32 overflow-hidden flex items-center">
      {/* Background Decorative Glow (Inverted for balance) */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-24">
          ...
          {/* Left Column: Strategic Copy (Inverted position) */}
          <motion.div
          ...
          >
            <div>
              <h2 className="text-4xl md:text-5xl lg:text-5xl font-black leading-[1.1] tracking-[-0.03em] text-white mb-6 uppercase">
                Gestão Fiscal & <br />
                <span className="text-ember">Automação Comercial</span> <br />
              ...
              <p className="text-[#8a8a8a] text-base md:text-lg font-light leading-relaxed max-w-xl">
                Desenvolvemos a infraestrutura de PDV (Frente de Caixa) e Gestão para o varejo físico, 
                garantindo que a operação nunca pare e esteja 
                <span className="text-ember font-bold"> 100% legalizada</span>.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              {[
                { 
                  emoji: "🧾", 
                  title: "Fiscal Nativo", 
                  desc: "Emissão automática de NF-e, NFC-e e integração com SEFAZ." 
                },
                { 
                  emoji: "📱", 
                  title: "Mobilidade Total", 
                  desc: "Sistema homologado para maquininhas Smart POS (Stone/PagSeguro)." 
                },
                { 
                  emoji: "📦", 
                  title: "Controle de Estoque", 
                  desc: "Gestão inteligente de entradas, saídas e inventário em tempo real." 
                },
                { 
                  emoji: "☁️", 
                  title: "Cloud Sync", 
                  desc: "Dados sincronizados na nuvem para acesso de qualquer lugar." 
                }
              ].map((item, idx) => (
                <motion.div 
                  key={idx}
          ...
          {/* Right Column: Mockup Image with Motion (Inverted position) */}
          <motion.div
          ...
          >
            <motion.div
              ...
              className="relative w-full aspect-[4/3] drop-shadow-[0_20px_100px_rgba(34,197,94,0.1)]"
            >
              <Image
                src="/mockup-retail-black.png"
                alt="Mockup FireFozDev Retail POS"
                fill
